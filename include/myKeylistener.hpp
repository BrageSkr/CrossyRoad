...
public:
    void onKeyPressed(
        ...
        if (evt.key == 87 /*w*/ or evt.key == 265 /*uparrow*/) {
            keyInput_.up = true;
        } else if (evt.key == 83/*s*/ or evt.key == 264 /*downarrow*/) {
            keyInput_.down = true;
        } else if (evt.key == 68/*d*/ or evt.key ==	262 /*rightarrow*/) {
            keyInput_.right = true;
        } else if (evt.key == 65/*a*/ or evt.key == 263 /*leftarrow*/) {
            keyInput_.left = true;
    ...
    void onKeyReleased(
        ...
        } else if (evt.key == 82/*r*/ or evt.key == 27 /*leftarrow*/) {
